...
public class ActivityOtp extends AppCompatActivity {
    ...
    private static String TAG = "smart_doorlock";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEditTextPw = (EditText)findViewById(R.id.editText_main_pw);
        ...
        buttonInsert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                task.execute("http://" + IP_ADDRESS + "/temppw.php", name,pw);
    ...
    class InsertData extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(ActivityOtp.this,
